...
export const blogArticles = [
  {
    ...
    paragraphs: [
      ...
      "River decisions deserve special care because there are no more cards to come. Bluff-catching is where many players lose clarity because they think only about their hand strength. Top pair can be a strong hand on the flop and still be a bad call on the river. When facing a large river bet, count value hands and natural bluffs. If the value list is long and the bluff list is short, folding is often the professional decision.",
